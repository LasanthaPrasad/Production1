from app import db, SolarPlant, GridSubstation, Feeder, ForecastLocation

def init_db():
    # Create sample data for Solar Plants in Sri Lanka
    solar_plant1 = SolarPlant(
    ...
    db.session.add(solar_plant1)
    db.session.add(solar_plant2)

    # Create sample data for Grid Substations in Sri Lanka
    ...
    # Create sample data for Feeders in Sri Lanka
    feeder1 = Feeder(
    ...
    # Create sample data for Forecast Locations in Sri Lanka
